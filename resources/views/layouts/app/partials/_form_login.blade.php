    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="block-content block-content-full ">
                <form action="{{url('/login')}}" method="POST" id="loginForm" class="form-horizontal">
                    <div class="form-group" id="login-email">
                        ...
                        <span class="help-block">
                            <strong id="login-errors-email"></strong>
                        </span>
                        </div>
                    </div>
                    <div class="form-group" id="login-password">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="help-block">
                                <strong id="login-errors-password"></strong>
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-2 col-md-offset-4">
                            <button type="submit" class="btn btn-primary" name="ingresar"> @lang('cabecera.Login')
                            </button>

                        </div>
                        <div class="col-md-6">
                            <a href="#"> @lang('cabecera.form_forgot')</a>
                        </div>
                    </div>
                </form>
            </div>
