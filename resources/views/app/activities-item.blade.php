...
<div class="content-boxed content content-full">
    <div class="col-md-8 bg-white slc">
        <div class="bg-white content content-narrow">
            <div class=" push-20  ">
              ...
              <!--  <div class="row content-mini content-mini-full border-t">
                    ...
                    <div class="text-muted col-sm-6">{{$item->days}}</div>
                </div>
                <div class="row content-mini content-mini-full border-t">
            ...
            <div class="">
                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        <div class="panel-body text-muted">
                        @lang('general.msjactivityitinerary') 
                            <ul class="fa-ul">
                                @php
                                $items = explode(",", $item->itinerary);
                                @endphp
                                @foreach($items as $i)
                                @if($i!=null)
                                <li><i class="fa fa-angle-right fa-li"></i>{{$i}}
                                </li>
                                @endif
                                @endforeach
                            </ul>
