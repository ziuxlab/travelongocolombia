        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-12 bg-white remove-padding">
                <div class="table-responsive">
                    ...
                    <div class="push-20 push-20-r text-right">
                        <a href="{{'/'}}" class="btn btn-default push-15-r">Continue Shopping</a>
                        <a href="{{'cheackout/payment'}}" class="btn btn-primary">Proceed payment</a>
                    </div>
                </div>
