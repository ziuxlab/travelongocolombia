<div class="row">
    <div class="col-sm-6">
        <div class="form-group {{ $errors->has('tittle') ? ' has-error' : '' }}">
            ...
            {!! Form::text('tittle', old('tittle'), ['class' => 'form-control','placeholder'=>'Ingrese el título de la actividad (H1)','required']) !!}
...
<div class="col-sm-12">
    <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
        ...
        {!! Form::textarea('description', old('descripcion'), ['class' => 'form-control','placeholder'=>'Ingrese la descripción de la actividad','required']) !!}
...
<div class="row">
    <div class="col-sm-3">
        <div class="form-group {{ $errors->has('duration') ? ' has-error' : '' }}">
            {!! Form::label('Duración:', null, ['class' => 'control-label']) !!}
            {!! Form::text('duration', old('duration'), ['class' => 'form-control','placeholder'=>'4 hours']) !!}
