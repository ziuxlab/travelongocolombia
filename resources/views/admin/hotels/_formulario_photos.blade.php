                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <button  class="js-swal-update btn btn-xs btn-default"
                                        ...
                                        {!! Form::open(['action'=> ['HotelController@update_order_photo',$item->id],'method'=>'post','id'=>'update_'.$item->id]) !!}
                                        {!! Form::close() !!}
                                    </button>
                                    <button class="js-swal-confirm btn btn-xs btn-default"
                                        ...
                                        {!! Form::open(['action'=> ['HotelController@delete_photo',$item->id],'method'=>'delete','id'=>'item_'.$item->id]) !!}
                                        {!! Form::close() !!}
                                    </button>
                                </div>
                            </td>
