...
@section('contenido')
    @include('layouts.admin.partials._titulos_CRUD',['h1'=>'Categoría','h2'=>'Crear Categoría'])
    <div class="content overflow-hidden">
        <div class="col-sm-12">
            <div CLASS="block block-bordered block-rounded block-themed ">
                {!! Form::open(['action'=> ['FeaturesController@store']]) !!}
                <div class="block-header bg-primary">
                    <h3 class="h4">@lang('general.form',['name'=>'Categoría']) </h3>
                </div>
