...
<div class="form-group {{ $errors->has('body') ? ' has-error' : '' }}">
    ...
    {!! Form::textarea('body', old('body'), ['class' => 'form-control','id'=>'js-ckeditor','placeholder'=>'Ingrese su contenido','required']) !!}
    @if ($errors->has('body'))
        <span class="help-block">
...
<div class="form-group {{ $errors->has('meta_description') ? ' has-error' : '' }}">
    ...
    {!! Form::textarea('meta_description', old('meta_description'), ['class' => 'form-control','placeholder'=>'Ingrese su resumen (SEO)','rows'=>'3','required']) !!}
...
<div class="form-group {{ $errors->has('keywords') ? ' has-error' : '' }}">
    ...
    {!! Form::text('keywords', old('keywords'), ['class' => 'form-control','placeholder'=>'Ingrese sus Palabras Clave', 'required']) !!}
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group {{ $errors->has('menu_order') ? ' has-error' : '' }}">
            {!! Form::label('Número de ubicación en el menú:', null, ['class' => 'control-label']) !!}
