...
<button data-dismiss="modal" type="button"><i class="si si-close"></i></button>
</li></ul><h3 class="block-title">CHILD EXPLOITATION</h3></div><div class="block-content"><img alt="" class="img-responsive push-20" src="//travelongocolombia.com/img/sustainability/English-b.jpg" /><p><strong> Travel<span class="text-primary">on</span>go</strong> Colombia refuses and denounces all kind of exploitative child labor for porpose of profit or other benefit.</p><p>Call to:<br />Calling to Bienestar Familiar (ICBF) 01-8000-91-80-80<br />Police emergency number 123</p></div></div><div class="modal-footer"> <a class="btn btn-minw btn-primary" data-dismiss="modal" href="#" type="button"> Ok </a></div></div></div></div></div></div></div></div>',
				'menu_order' => 7,
				'local'      => 'en',
				'tipo'       => 0,
...
<button data-dismiss="modal" type="button"><i class="si si-close"></i></button>
</li></ul><h3 class="block-title">COMERCIALIZACI&Oacute;N Y DA&Ntilde;O DE BIENES CULTURALES</h3></div><div class="block-content"><img alt="" class="img-responsive push-20" src="//travelongocolombia.com/img/sustainability/Español-D.jpg" /><p><strong> Travel<span class="text-primary">on</span>go</strong> Colombia rechaza comercializaci&oacute;n y da&ntilde;o de bienes culturales Ley 103 de 1991 Si observa alguna acci&oacute;n que atente contra el patrimonio cultural y arqueol&oacute;gico de nuestro pa&iacute;s.</p><p>Llamar a:<br />Polic&iacute;a Nacional: 123</p><h4>Se&ntilde;or Turista</h4><p>Cada vez que usted se dirija a otro pa&iacute;s con cualquier elemento que este catalogado como patrimonio cultural, usted debe solicitar la autorizaci&oacute;n de exportaci&oacute;n ante las entidades competentes:</p><ul>	<li>Bienes documentales: Archivo general de la naci&oacute;n Web: <a href="www.archivogeneral.gov.co">www.archivogeneral.gov.co</a></li>	<li>Toda clase de bienes culturales: Ministerio de Cultura - Direcci&oacute;n de Patrimonio Web <a href="www.mincultura.gov.co">www.mincultura.gov.co</a></li>	<li>Patrimonio arqueol&oacute;gico o replicas: Instituto Colombiano de Antropolog&iacute;a e Historia Web: <a href="www.icanh.gov.co">www.icanh.gov.co</a></li></ul></div></div><div class="modal-footer"><a class="btn btn-minw btn-primary" data-dismiss="modal" href="#">Ok </a></div></div></div></div></div><div class="col-sm-6"><a class="block block-transparent  block-rounded block-link-hover2" data-target="#flora" data-toggle="modal" href="#"><img alt="flora and fauna colombia" class="img-responsive" src="//travelongocolombia.com/img/sustainability/Español-C.jpg" /> </a><div class="push-10-t"><h5><a class="block block-transparent  block-rounded block-link-hover2" data-target="#flora" data-toggle="modal" href="#">Nosotros Protegemos la Fauna y Flora</a></h5></div><a class="block block-transparent  block-rounded block-link-hover2" data-target="#flora" data-toggle="modal" href="#"> </a><div class="fade modal" id="flora"><div class="modal-dialog modal-dialog-popin"><div class="modal-content"><div class="block block-themed block-transparent remove-margin-b"><div class="bg-primary-dark block-header"><ul class="block-options">	<li>
<button data-dismiss="modal" type="button"><i class="si si-close"></i></button>
...
<button data-dismiss="modal" type="button"><i class="si si-close"></i></button>
</li></ul><h3 class="block-title">EXPLOTACI&Oacute;N INFANTIL</h3></div><div class="block-content"><img alt="" class="img-responsive push-20" src="//travelongocolombia.com/img/sustainability/Español-B.jpg" /><p><strong> Travel<span class="text-primary">on</span>go</strong> Colombia rechaza y denuncia todo tipo de trabajo realizado por menores de edad a cambio de dinero u otro beneficio.</p><p>Denuencie:<br />Denuncie en la l&iacute;nea Gratuita Nacional de Bienestar Familiar (ICBF) 01-8000-91-80-80<br />Policia Nacional 123</p></div></div><div class="modal-footer"> <a class="btn btn-minw btn-primary" data-dismiss="modal" href="#" type="button"> Ok </a></div></div></div></div></div></div></div></div>',
				'menu_order' => 7,
				'local'      => 'es',
				'tipo'       => 0,
				'img'        => 'img/Sustainability-PolicyC.jpg',
